    ...
    <div className="bg-[radial-gradient(#cbd5e1_1.5px,transparent_1px)] bg-size-[25px_25px]">
      <div className=" flex flex-col items-center px-2 py-10 md:px-5 gap-5 bg-linear-to-br from-indigo-100 via-white to-purple-100">
        ...
        <div className="flex md:flex-row flex-col gap-7">
          <div className="flex flex-col md:border-none border-l-2 border-[#021645] items-start gap-5 p-5">
            <h1 className="font-bold text-[#000000] text-[0.9rem] md:text-[1rem]">
              A Team That Thinks Beyond Code
            </h1>
            <p className="text-[0.8rem] text-[#000000] md:text-[0.9rem] font-medium  text-start">
      ...
      >
        ...
        >
          <Image
            ...
            alt="WhyUs"
            width={"100%"}
            className="w-full md:w-1/2 mx-auto hover:scale-105 transition-all duration-500 ease-in-out"
          />
        </motion.div>
        <motion.div variants={childVariants} className="w-full">
          <p className="text-[0.8rem] md:w-2/3 md:leading-6 md:text-[0.9rem] font-medium">
